//! Compile and link the existing, validated CUDA kernels (`c/backend_cuda.cu`)
...
fn main() {
    ...
    // repo layout: rust/crates/coli-cuda/build.rs → ../../../c/backend_cuda.cu
    let src = "../../../c/backend_cuda.cu";
